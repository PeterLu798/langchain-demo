...
from agent.models.Factory import ChatModelFactory
from agent.tools.ExcelTool import get_first_n_rows
from agent.utils.CallbackHandlers import ColoredPrintHandler
from agent.utils.PrintUtils import CODE_COLOR
...
if __name__ == "__main__":
    print(ExcelAnalyser(
        ChatModelFactory.get_model("deepseek"),
    ).analyse(
        query="8月销售额",
